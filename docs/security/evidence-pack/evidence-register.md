...
| Privileged accounts | MFA policy/UI, unique admin register, session control test | Step 4 commit `20ae86d`; not yet deployed/applied | service owner | monthly |
| Security audit events | migration, sample event without content, access-denial test | Step 5 commit `a4fed8e`; not yet deployed/applied | security lead | weekly/quarterly |
...
| Independent testing | scoped test report and remediation closure | not commissioned—Step 7 | service owner | before GA/annually |
